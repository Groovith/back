...
public class ChatRoomController {
    ...
    public ResponseEntity<ChatRoomDetailsDto> findChatRoomDetails(@PathVariable(name = "chatRoomId") Long chatRoomId,
                                                                  @AuthenticationPrincipal CustomUserDetails userDetails) {
        return chatRoomService.findChatRoomDetails(chatRoomId, userDetails.getUserId());
    }
